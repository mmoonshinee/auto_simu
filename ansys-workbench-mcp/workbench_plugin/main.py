...
def on_extension_startup(extension_context=None):
    """Called by ACT oninit when the extension loads."""
    _debug_log("on_extension_startup called")
    _auto_start_mcp_socket_timer()
    _auto_start_queue_timer()


# Also auto-start when the module is imported directly
