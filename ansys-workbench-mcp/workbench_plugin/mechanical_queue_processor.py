...
def _state_payload():
    ...
    try:
        try:
            ...
            _tree2 = None
        if _tree2 is not None:
            payload["tree_active"] = [obj.Name for obj in _tree2.ActiveObjects]
    except Exception:
        payload["tree_active"] = []
    return payload
